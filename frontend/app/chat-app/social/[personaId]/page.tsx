...
export default function PersonaProfilePage() {
    ...
    if (!profile) {
        return (
            <div className="mx-auto flex w-full max-w-3xl flex-col gap-4 pb-12">
                <Button className="w-fit" icon={<ArrowLeftOutlined />} onClick={() => router.push('/chat-app/social')}>
                    PersonaFeed
                </Button>
    ...
    return (
        <div className="mx-auto flex w-full max-w-3xl flex-col gap-4 pb-12">
            <Button className="w-fit" type="text" icon={<ArrowLeftOutlined />} onClick={() => router.push('/chat-app/social')}>
                PersonaFeed
            </Button>
